...
cryptogram.testVar = "moo";

cryptogram.doc = function () { return content.document; };
...
cryptogram.context = {
  ...
  removeStatusDiv: function() {  
      var status = cryptogram.doc().getElementById("cryptogramStatus");
      if (!status) return;
  ...
  createStatusDiv: function() {
    ...
    var div = cryptogram.doc().createElement("div");
  ...
  setStatus: function(message) {
    ...
    cryptogram.context.status = cryptogram.doc().getElementById("cryptogramStatus");
  ...
  getContainer: function() {
    var elements = cryptogram.doc().getElementsByTagName('img');  
...
cryptogram.context.facebook = {
  ...
  fixURL: function(URL) {
    ...
    var projectorA = cryptogram.doc().getElementById(FBAName);
    ...
    // Regular image page 
      ...
      var elements = cryptogram.doc().getElementsByClassName('fbPhotosPhotoActionsItem');
  ...
  getAlbumName: function(URL) {
    var browserURL = cryptogram.doc().URL;
  ...
  getImages: function() {
    var images = cryptogram.doc().getElementsByTagName('img');
    var valid = [];
...
cryptogram.decoder.decodeDataToContainer = function(data, password, container) {
  ...
  var canvas = cryptogram.doc().createElement('canvas');
...
// Disable chrome-specific functions
//cryptogram.init();
