...
function extractRGB(src, container, newImg) {
    ...
    var img = new Image();
  	...
  	img.onload = function(){
	      ...
	      for (y = 0; y < img.height; y+= blockHeight) {
		        for (x = 0; x < img.width; x+= (blockWidth * 2)) {

		            hex0 = getWRGBK(imageData, img.width, x, y, blockWidth, 
                                blockHeight);
		            hex1 = getWRGBK(imageData, img.width, x + blockSize, y, 
