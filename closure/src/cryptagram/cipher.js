...
cryptagram.cipher.prototype.logger = goog.debug.Logger.getLogger('cryptagram.cipher');

cryptagram.cipher.URIHeader = "data:image/jpeg;base64,";

/**
 */
cryptagram.cipher.prototype.decrypt = function(newBase64, password) {
